      ...
      <section className="snap-section flex items-center justify-center relative z-10">
        <div className="max-w-4xl mx-auto px-6 md:px-10">
          ...
          <RevealBlock delay={0.5}>
            ...
            >
              We're specialists in cultural strategy, cross-sector organizing, and philanthropy — working across six sectors to help donors and foundations get strategic communications right.
            </p>
          </RevealBlock>
        </div>
      </section>

...
const PAIN_POINTS = [
  {
    ...
    detail: "You're building a strategic communications portfolio from scratch — no track record of what's been funded or what's working.",
  ...
  },
  {
    ...
    detail: "Your grantees recycle the same playbook — op-eds, paid media, social. The most powerful cultural channels stay untapped.",
  ...
  },
  {
    ...
    detail: "Grantees send views and impressions. Other donors tie funding to impossible benchmarks. You need to tell the real impact story.",

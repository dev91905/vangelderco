...
const PAIN_POINTS = [
  ...
  },
  {
    ...
    detail: "No framework for evaluating proposals or advising grantees. Decisions default to inertia.",
  ...
  },
  {
    ...
    detail: "You're running on op-eds, paid media, and maybe a doc no one watches. The full stack is invisible.",
  ...
  {
    id: "measurement",
    short: "Metrics that don't translate",
    detail: "You're collecting views and impressions, but can't connect them to the impact story that matters.",
  ...
  },
  {
    ...
    detail: "Hard to diagnose the problem without experience operating inside the sectors you're trying to activate.",

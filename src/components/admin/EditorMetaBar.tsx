    ...
    <>
      ...
      <div className="w-full flex flex-col items-center px-6" style={{ paddingTop: "3vh" }}>
        ...
        <div className="flex flex-col items-center w-full" style={{ maxWidth }}>
          {/* Meta row: capability + settings gear */}
        ...
        <>
          ...
          <div className={`fixed z-50 overflow-y-auto ${isMobile ? "inset-x-0 bottom-0 rounded-t-2xl max-h-[85vh]" : "top-0 right-0 h-full w-96"}`}
            ...
            <div className="flex items-center justify-between px-5 py-4" style={{ borderBottom: t.border(0.06) }}>
              <span className="text-sm font-medium" style={{ fontFamily: t.sans, color: t.ink(0.6) }}>Settings</span>
            ...
            <div className="p-5 space-y-8">
              {/* ─── PUBLISHING ─── */}
              <div>
                <div className="text-[10px] uppercase tracking-[0.14em] mb-4 font-semibold" style={{ fontFamily: t.sans, color: t.ink(0.25) }}>
                  Publishing
                </div>
              ...
              {/* Separator */}
              <div style={{ height: "1px", background: t.ink(0.06) }} />

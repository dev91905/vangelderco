    ...
    <AtmosphericLayout>
      ...
      <div className="relative z-20 h-dvh overflow-y-auto" style={{ animation: "fade-up 0.5s ease-out both" }}>
        ...
        <main className="flex flex-col items-center px-6 pb-20 max-w-[680px] mx-auto -mt-16 relative z-10">
          ...
          <h1 className="text-[32px] md:text-[44px] font-medium leading-[1.15] text-center mb-4" style={{ fontFamily: t.serif, color: t.ink(0.9), animation: "fade-up 0.5s ease-out 0.3s both" }}>
            {post.title}
          </h1>
